...
def spyder(SeedUrl, target):
    ...
    c = conn.cursor()
    #creates toCrawl database 0.o
    c.execute("""CREATE TABLE toCrawl();""")
    #creates crawled database 0.o
    c.execute("""CREATE TABLE crawled();""")
    #get start of process
    startTime = time.localtime()
    seqNum = 0
    #DB of links to crawl in the future
    #tocrawTable = "toCrawl.db"
    tocrawl=[SeedUrl]
    ...
    while tocrawl:
        page="SELECT TOP %s url FROM toCrawl;", pos
